...
class TestXiaoxi1(unittest.TestCase):
    ...
    def test_case_fuzhi(self):
        try:
            driver = self.driver
            el1 = driver.find_element_by_xpath('//android.widget.TextView[contains(@text, "伊把手官方交流群")]')
            el1.click()
            sleep(5)
            for i in range(1, 4):
            ...
            el4.click()
            sleep(3)
            TouchAction(driver).long_press(el4, duration=3000).wait(2000).perform()
            sleep(3)
    ...
    def test_case_zhuanfa(self):
        try:
            ...
            el3.click()
            sleep(3)
            el4 = driver.find_element_by_xpath('//android.widget.TextView[contains(@text, "云聊官方交流群")]')
            el4.click()
            ...
            el8 = driver.find_element_by_xpath('//android.widget.TextView[contains(@text, "云聊官方交流群")]')
            el8.click()
            sleep(5)
