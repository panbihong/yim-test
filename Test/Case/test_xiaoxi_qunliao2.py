...
class TestXiaoxi2(unittest.TestCase):
    ...
    def test_case_zhuanfa_zhutiao(self):
        try:
            ...
            el10.click()
            sleep(3)
            el11 = driver.find_element_by_xpath('//android.widget.TextView[contains(@text, "云聊官方交流群")]')
            el11.click()
            sleep(3)
            ...
            el14 = driver.find_element_by_xpath('//android.widget.TextView[contains(@text, "云聊官方交流群")]')
            el14.click()
            sleep(8)
